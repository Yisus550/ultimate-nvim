...
-- Override p and P to always paste from system clipboard
keymap.set("n", "p", '"+p', { desc = "paste from system clipboard after cursor" })
keymap.set("n", "P", '"+P', { desc = "paste from system clipboard before cursor" })
keymap.set("v", "p", '"+p', { desc = "paste from system clipboard" })
keymap.set("v", "P", '"+P', { desc = "paste from system clipboard before" })
...
-- Switch windows (navigate between splits and explorer)
